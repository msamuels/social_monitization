...
<div class="col-sm-6">
    ...
    <div class="row">
        ...
        <p>To do this we have developed this platform where the producers of these efforts can present what they are
            working on and where you can help them get exposure by simply sharing this on social media with your friends
            and family. These efforts range from large undertakings (e.g. a non-profit helping to build schools across
            Jamaica) to the small (e.g. local entrepreneurs creating a breakthrough app). Regardless of the size, what
            we are asking you to do remains the same: share it with you network.
        </p> 

        <h2>AND MAKES IT REWARDING</h2>

        <P>We think that this act of helping to raise awareness of work that is valuable is not something small. You are
            not only helping by directing attention their way but ultimately you are helping them in their mission of
