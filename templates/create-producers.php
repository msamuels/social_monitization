    ...
    <div class="col-sm-9">
        ...
        <form action="/save-producer" method="POST" id="create-producer">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" name="organization_url" placeholder="Website (ex. www.shareitcamp.com)"/>
                </div>
            </div>
            ...
            <div class="form-group">
                <span class="forminfo">
                    <a href="#" class="tooltip"  data-toggle="tooltip" data-placement="right" title="Non-profit
                groups do not pay a fee for using this service">?</a>
                </span>
